...
This step is the client part of the client/server application. the rule engine runs on a
server and this client sends data to the server and receives the results of the rule
engine.
